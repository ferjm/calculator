...
var StaticResources = {
  ...
  resources: {
    ...
    inlineCache '/app/js/protocols/cache/parent.js'
    inlineCache '/app/js/protocols/update/child.js'
    inlineCache '/app/js/protocols/update/parent.js'
    inlineCache '/app/js/protocols/service/child.js'
